...
@AndroidEntryPoint
class GPUInfoKt : ComponentActivity(), OnExportTaskFinished {

    private val viewModel by viewModels<GPUViewModelKt>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val onBack = {
                interstitialAdManager.maybeShowInterstitial(this@GPUInfoKt) { finish() }
            }

            DeviceInfoTheme {
                Scaffold(topBar = {
                    TopBar(title = stringResource(id = R.string.title_activity_gpu_info),
                        exportVisible = true,
                        onExportClick = {
                            export()
                        },
